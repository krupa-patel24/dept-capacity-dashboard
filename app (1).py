...
# ─── LOAD DATA ─────────────────────────────────
df = pd.read_csv("Dedication prediction.csv")

df.rename(columns={'job_end_date': 'job_effective_end_date'}, inplace=True)
...
fig.add_trace(go.Scatter(
    ...
    hovertemplate=
        ...
        'Project Day: %{x}<br>' +
        'Hours: %{y}<br><br>' +
        'Represents total available working capacity.<br>' +
        'Changes when jobs start/end.<extra></extra>'
))
...
fig.add_trace(go.Scatter(
    ...
    hovertemplate=
        ...
        'Project Day: %{x}<br>' +
        'Hours: %{y}<br><br>' +
        'Represents actual consumed effort.<br>' +
        'Shows cumulative work done.<extra></extra>'
))
...
fig.update_layout(
    ...
    annotations=[dict(
        ...
        text=(
            ...
            '🔵 <b>Available Hours:</b> Total available working capacity based on active jobs. '
            'When jobs end, available hours decrease.<br><br>'
            '🔴 <b>Spent Hours:</b> Actual consumed effort over project duration.<br><br>'
